...
//        this.salary = salary;
    ...
    private void setData() {
        ...
        try {
            ResultSet rs = MySql.select("SELECT * FROM `user_payments` INNER JOIN `paymenttype` ON `paymenttype`.`id` = `user_payments`.`paymentType_id`"
                    + " WHERE `DAT` LIKE '" + date + "%' AND `user_id` = '" + wId + "'; ");
            ...
            while (rs.next()) {
                ...
                v.add(i);
                v.add(rs.getString("user_payments.id"));
