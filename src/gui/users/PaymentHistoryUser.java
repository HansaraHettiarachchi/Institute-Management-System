 ...
 * @author nuwan
 */
public class PaymentHistoryUser extends javax.swing.JDialog {

    private String nic;

    public PaymentHistoryUser(java.awt.Frame parent, boolean modal, String nic) {
        super(parent, modal);
        initComponents();
        this.nic = nic;

        loadTeacherDetails(nic);
        populateYearAndMonthFilters();
        loadPaymentHistory(this.nic);
    ...
    private void loadTeacherDetails(String nic) {
        try {
    ...
    private void populateYearAndMonthFilters() {
        try {
            String query = "SELECT DISTINCT YEAR(DAT) AS year FROM user_payments;";
            ResultSet rs = MySql.select(query);
            ...
            jComboBox3.addItem("All Years");
            for (String year : years) {
                jComboBox3.addItem(year);
            }

            jComboBox4.removeAllItems();
            jComboBox4.addItem("All Months");
    ...
    private void loadPaymentHistory(String NIC) {
        try {
            String yearFilter = (String) jComboBox3.getSelectedItem();
            String monthFilter = (String) jComboBox4.getSelectedItem();

            String query = "SELECT Up.id, Up.DAT, Up.price, Up.desc, pt.name AS payment_method, u.nic\n"
                    + "FROM user_payments Up\n"
                    + "INNER JOIN user u ON Up.user_id = u.id\n"
                    + "INNER JOIN paymenttype pt ON Up.id = pt.id\n"
                    + "WHERE u.nic = '" + NIC + "' ";

            if (yearFilter != null && !yearFilter.equals("All Years")) {
                query += "AND YEAR(Up.DAT) = '" + yearFilter + "' ";
            }

            if (monthFilter != null && !monthFilter.equals("All Months")) {
                int monthNumber = getMonthNumber(monthFilter);
                if (monthNumber > 0) {
                    query += "AND MONTH(Up.DAT) = " + monthNumber + " ";
                }
            }

            query += "ORDER BY Up.DAT DESC";
    ...
    private void initComponents() {
        ...
        jLabel13.setText("Select by Year");
        ...
        jLabel14.setText("Select by Month");
        ...
        jLabel15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gui/icons/reset.png"))); // NOI18N
        jLabel15.setToolTipText("Reset");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Date", "Amount (Rs.)", "Payment Method", "desc"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PaymentHistoryUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                PaymentHistoryTeacher dialog = new PaymentHistoryTeacher(new javax.swing.JFrame(), true);
...
//        java.awt.EventQueue.invokeLater(new Runnable() {
//            public void run() {
//                PaymentHistoryUser dialog = new PaymentHistoryUser(new javax.swing.JFrame(), true);
//                dialog.addWindowListener(new java.awt.event.WindowAdapter() {
//                    @Override
//                    public void windowClosing(java.awt.event.WindowEvent e) {
//                        System.exit(0);
...
//        });
    ...
    private void resetFilters() {
        jComboBox3.setSelectedItem("All Years");
        jComboBox4.setSelectedItem("All Months");
        loadPaymentHistory(this.nic);
    }
