...
public class UserProfile extends javax.swing.JDialog {
    ...
    private void loadData() {
        try {
            ResultSet resultSet = MySql.select("SELECT u.*, s.*, g.*, \n"
                    ...
                    + "    quantumQube.user u\n"
                    + "LEFT JOIN \n"
                    + "    quantumQube.status s ON s.id = u.status_id\n"
                    + "LEFT JOIN \n"
                    + "    quantumQube.gender g ON g.id = u.gender_id\n"
                    + "LEFT JOIN \n"
                    + "    quantumQube.usertype ut ON ut.id = u.userType_id\n"
                    + "LEFT JOIN \n"
                    + "    quantumQube.address a ON a.id = u.address_id\n"
                    + "LEFT JOIN \n"
                    + "    quantumQube.city c ON c.id = a.city_id\n"
                    + "LEFT JOIN \n"
                    + "    quantumQube.district d ON d.id = c.district_id\n"
                    + "WHERE \n"
                    + "    u.nic = '" + this.nic + "';");
    ...
    private void loadProfileImage(String nic) {
        try {
            String query = "SELECT upi.location AS user_image_location\n"
                    + "FROM quantumQube.user u\n"
    ...
    private void initComponents() {
        ...
        jPanel7Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGap(181, 420, Short.MAX_VALUE))
            .addGroup(jPanel7Layout.createSequentialGroup()
                .addContainerGap()
        ...
        jPanel11Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel11Layout.createSequentialGroup()
                ...
                .addGap(181, 398, Short.MAX_VALUE))
            .addGroup(jPanel11Layout.createSequentialGroup()
                .addContainerGap()
        ...
        jPanel13Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel13Layout.createSequentialGroup()
                ...
                .addGap(181, 397, Short.MAX_VALUE))
            .addGroup(jPanel13Layout.createSequentialGroup()
                .addContainerGap()
        ...
        jPanel14Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel14Layout.createSequentialGroup()
                ...
                .addGap(181, 422, Short.MAX_VALUE))
        ...
        try {
            if (validation()) {
                ...
                if (canUpdate) {
                    ...
                    MySql.iud("UPDATE quantumQube.user\n"
                            + "SET email = '" + email + "',\n"
                            + "ps = '" + ps + "',\n"
                            + "fname = '" + firstName + "',\n"
                            + "lname = '" + lastName + "',\n"
